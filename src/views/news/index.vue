<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%" height="600">
            ...
            <el-table-column prop="newsdescribe" label="描述">
            </el-table-column>
            ...
            <el-table-column prop="newslink" label="跳转链接">
            </el-table-column>
        ...
        <el-dialog title="添加新闻" :visible.sync="dialogTableVisible" :close-on-click-modal="false">
            ...
            <div style="margin-bottom:20px">
                <el-input type="textarea" :rows="2" placeholder="请输入标题" v-model="addData.title">
                </el-input>
            </div>
            <div style="margin-bottom:20px">
                <el-input type="textarea" :rows="2" placeholder="请输入描述" v-model="addData.newsdescribe">
                </el-input>
            </div>
            <div style="margin-bottom:20px">
                <el-input type="textarea" :rows="2" placeholder="请输入链接" v-model="addData.newslink">
                </el-input>
            </div>
            <div style="margin-bottom:20px">
                是否头条<el-switch v-model="addData.newstop" :active-value="1" :inactive-value="0" active-color="#13ce66"
